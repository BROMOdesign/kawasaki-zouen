...
?>
    ...
    <div class="wrap">
     	...
     	<div id="mono_instructions">
     		...
     		<p style="font-size:16px;">【 <a href="https://tcd.style/login" rel="noopener" target="_blank"><?php _e( 'Download the latest theme from My Page', 'tcd-w' ); ?></a> 】<br />
            <span style="font-size:14px;"><?php _e( 'Click <a href="https://tcd-theme.com/2017/01/theme_update.html" rel="noopener" target="_blank">here</a> to find out how to update the theme.', 'tcd-w' ); ?></span>
            </p>
     		<div id="mono_info">
...
function get_latest_theme_version( $interval ) {
	...
	$notifier_file_url = 'http://design-plus1.com/notifier_beauty.xml';	
	$db_cache_field = 'beauty-contempo-notifier-cache';
	$db_cache_field_last_updated = 'beauty-contempo-notifier-last-updated';
