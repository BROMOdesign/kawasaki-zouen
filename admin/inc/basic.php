...
function add_basic_dp_default_options( $dp_default_options ) {
	...
	// Color
	$dp_default_options['primary_color'] = '#111111';
	$dp_default_options['secondary_color'] = '#422414';
	$dp_default_options['content_link_color'] = '#422414';
	...
	// Loading screen
	$dp_default_options['use_load_icon'] = 0;
